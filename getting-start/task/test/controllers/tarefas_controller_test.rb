...
class TarefasControllerTest < ActionController::TestCase
  ...
  test "should create tarefa" do
    assert_difference('Tarefa.count') do
      post :create, tarefa: { descricao: @tarefa.descricao, status: @tarefa.status, titulo: @tarefa.titulo }
    end
  ...
  test "should update tarefa" do
    patch :update, id: @tarefa, tarefa: { descricao: @tarefa.descricao, status: @tarefa.status, titulo: @tarefa.titulo }
    assert_redirected_to tarefa_path(assigns(:tarefa))
  end
